...
Another famous NP-complete problem is the [travelling salesman problem](https://en.wikipedia.org/wiki/Application_layer), mentioned by Cueball at the end, referring to the waiter's claim that he has 6 more tables to get to. (see also [399: Travelling Salesman Problem](https://en.wikipedia.org/wiki/Application_layer)).
